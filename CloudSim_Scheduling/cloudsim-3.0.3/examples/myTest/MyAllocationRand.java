...
//		}
    ...
    public static void main(String[] args) {
        Log.printLine("Starting MyAllocationRand...");
        ...
        try {
            ...
            broker.bindCloudletToVmRand(cloudletList,vmlist);
            ...
            Log.printLine("MyAllocationRand finished!");
        }
        catch (Exception e)
        {
            e.printStackTrace();
